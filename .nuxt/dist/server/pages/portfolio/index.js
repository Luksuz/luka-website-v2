...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/portfolio/index.vue?vue&type=template&id=0e9af614&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<h1 class=\"mt-6 text-2xl font-bold capitalize\">Web Applications</h1> "),_c('CustomBorder'),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"mt-8\">","</div>",[_c('PortfolioWebApps')],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"max-w-xl shadow-2xl h-40 py-5 md:py-0 px-5 md:px-10 mt-10 md:flex justify-between items-center\">","</div>",[_vm._ssrNode("<p class=\"text-lg font-bold mb-3 md:mb-0\">\n      I cook with these ingredients 👉\n    </p> "),_c('Button',{attrs:{"displayTitle":"MY RESUME","linkTo":"/resume"}})],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/portfolio/index.vue?vue&type=template&id=0e9af614&
